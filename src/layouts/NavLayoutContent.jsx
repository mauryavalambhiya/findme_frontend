    ...
    return (
      <>
        <div className="relative">
          ...
          <div 
          className={`w-lvh h-fit flex flex-row justify-between px-3 py-3 relative z-50 bg-transparent ${theam === 'DARK' ? 'border-b-2 border-white' : ''}`}>
...
export default NavLayoutContent